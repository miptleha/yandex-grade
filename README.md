...
* Работа с графами, *11 часов* :man: [Контест](https://contest.yandex.ru/contest/59363/problems/)
  - [ ] Работа с графами
...
Уроки теоритические, но встречаются ссылки на `Яндекс Контест`, где при желании можно алгоритмы реализовать и применить.  
Сначала решал на `C#`, но потом проникся духом `Python` и стал на нем решать.  
Если проходить, решая контест, каждый курс займет от одного до нескольких дней, в зависимости от сложности курса.  
